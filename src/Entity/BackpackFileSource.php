...
class BackpackFileSource implements EntityInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Backpack", inversedBy="backpackFileSources")
    ...
    {
        return 'uploads/backpacksSource/' . $this->getBackpack()->getId();
    }
    ...
    public function setFile(UploadedFile $backpacksFile): BackpackFileSource
    {
