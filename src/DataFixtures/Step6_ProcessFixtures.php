...
class Step6_ProcessFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    [
        ...
        ['Gestion de la demande d\'évolution du système d\'information', 'S3', 'S3-1', ''],
        ['Cadrage et définition de projet', 'S3', 'S3-2', ''],
        ['Concéption détaillée et réalisation', 'S3', 'S3-3', ''],
        ['Recette', 'S3', 'S3-4', ''],
        ['Gestion les changements et les mise en production', 'S3', 'S3-5', ''],
        ['Gestion des configurations', 'S3', 'S3-6', ''],
        ['Traitements informatiques', 'S3', 'S3-7', ''],
        ['Traitements éditiques', 'S3', 'S3-8', ''],
        ['Gestion de la qualité de service', 'S3', 'S3-9', ''],
        ['Gestion des incidents', 'S3', 'S3-10', ''],
        ['Gestion des événements', 'S3', 'S3-11', ''],
        ['Gestion des demandes de service', 'S3', 'S3-12', ''],
        ['Gestion de l\'informatique locale', 'S3', 'S3-13', ''],
        ...
        ['Clinique dentaire', 'M5', 'M5-1', ''],
        ['Centre de santé', 'M5', 'M5-2', ''],
