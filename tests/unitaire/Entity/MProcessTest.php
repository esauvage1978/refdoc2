...
class MProcessTest extends KernelTestCase
{
    private $nameGood = 'abcdef';
    private $refGood = '000';

    public function createEntity(): MProcess
    {
        return (new MProcess());
    }

    public function assertHasErros(MProcess $mp, $number = 0, $message)
    {
        self::bootKernel();
    ...
    public function testCreate()
    {
        ...
        $this->assertHasErros($mp, 2, 'test de creation');
        $this->assertInstanceOf(MProcess::class, $mp);
    }
